...
<Typography variant='body1' color='primary' sx={{fontSize:'0.87rem'}}>{medication.pharmacy?.name}</Typography>
  ...
  <Typography variant='h4' sx={{fontSize:isNonMobile?'1.4rem':'1.2rem',py:1}} >Description</Typography>
  <Typography variant='body2' sx={{fontSize:isNonMobile?'0.9rem':'1rem'}}>
  ...
  <Divider sx={{ my: 1 }} />
  <Typography variant='h5' sx={{fontSize:isNonMobile?'1.4rem':'1.2rem',pb:1}} >Medicine Contains</Typography>
  <Typography variant='body2' sx={{fontSize:isNonMobile?'0.9rem':'1rem'}}>
